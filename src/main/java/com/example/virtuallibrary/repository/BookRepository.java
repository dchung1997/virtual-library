...
public interface BookRepository extends PagingAndSortingRepository<Book, String> {
    ...
    @Query("SELECT b FROM Book b WHERE categories LIKE '%Business%' OR categories LIKE '%Self-Help%' OR categories LIKE '%Art%' OR categories LIKE '%Biography%' OR categories LIKE '%Philosophy%' OR categories LIKE '%Psychology%' OR categories LIKE '%Sports%' OR categories LIKE '%Poetry%' OR categories LIKE '%History%' ORDER BY RANDOM()" )
